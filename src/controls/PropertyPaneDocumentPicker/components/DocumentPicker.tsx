...
import { IDocumentPickerProps } from './IDocumentPickerProps';
import { IDocumentPickerState } from './IDocumentPickerState';
 ...
 */
export default class DocumentPicker extends React.Component<IDocumentPickerProps, IDocumentPickerState> {
   ...
   * Constructor
   */
  constructor(props: IDocumentPickerProps, state: IDocumentPickerState) {
    super(props);
...
//      this.props.properties[this.props.targetProperty] = newValue;
      this.props.properties.targetProperty = newValue;
      // {
      //   targetProperty : newValue
      // }
//      this.props.onPropertyChange(this.props.targetProperty, oldValue, newValue);
      this.props.onPropertyChange(this.props.properties.targetProperty, oldValue, newValue);
      // if (!this.props.disableReactivePropertyChanges && this.props.render != null)
      //   this.props.render();
        if (!this.props.disableReactivePropertyChanges && this.props.properties.render != null)
        this.props.properties.render();
    }
  }
...
//    var iframeUrl = this.props.context.pageContext.web.absoluteUrl;
  //  var iframeUrl = this.context.pageContext.web.absoluteUrl;
    ...
    return (
      <div>
            <TextField label="Message" value="This is the DocumentPicker message"/>
      </div>
    );
  }
